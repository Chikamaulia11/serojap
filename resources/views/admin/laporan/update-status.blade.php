...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">
            Perbarui status laporan jalan rusak secara cepat
        </p>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 mb-6">
        ...
        <form
            method="GET"
            action="{{ route('admin.laporan.update-status') }}"
        ...
        >
            ...
            <a
                href="{{ route('admin.laporan.update-status') }}"
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <form
                                action="{{ route('admin.laporan.update', $item->id) }}"
                                method="POST"
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    class="bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium rounded-lg px-3 py-1.5 transition"
                                >
                                    Simpan
                                </button>
        ...
        <div class="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <div class="flex gap-1">
                ...
                @foreach($laporan->getUrlRange(1, $laporan->lastPage()) as $page => $url)
                    ...
                    <a
                        href="{{ $url }}"
                        class="px-3 py-1.5 text-sm rounded-lg border transition {{ $laporan->currentPage() == $page ? 'bg-indigo-600 text-white border-indigo-600' : 'text-gray-700 border-gray-300 hover:bg-gray-50' }}"
                    >
                        {{ $page }}
                    </a>
