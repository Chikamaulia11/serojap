...
<div class="max-w-7xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">Kelola dan verifikasi semua laporan jalan rusak yang masuk</p>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 mb-6">
        <form method="GET" action="{{ route('admin.laporan.index') }}" class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('admin.laporan.index') }}" class="bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 transition">
                Reset
            </a>
        </form>
    </div>
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4">
                            @if($item->foto)
                                <img src="{{ asset('storage/' . $item->foto) }}" alt="foto" class="w-12 h-12 rounded-lg object-cover border border-gray-200">
                            @else
