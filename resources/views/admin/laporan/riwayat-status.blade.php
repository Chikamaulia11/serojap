...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 mt-1">
            Lihat semua riwayat perubahan status laporan
        </p>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 mb-6">
        ...
        <form
            method="GET"
            action="{{ route('admin.laporan.riwayat-status') }}"
        ...
        >
            ...
            <a
                href="{{ route('admin.laporan.riwayat-status') }}"
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-gray-400 text-[11px]">
                                        ...
                                        {{ $item->laporan->latitude ?? '-' }},
                                        {{ $item->laporan->longitude ?? '-' }}
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        @if(!empty($item->foto_perbaikan))
                                            ...
                                            <div>
                                                ...
                                                <img
                                                    src="{{ asset('storage/' . $item->foto_perbaikan) }}"
                                                    alt="Foto Perbaikan"
                ...
                <div class="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ...
                        @if($riwayat->onFirstPage())
                            ...
                            <span class="px-3 py-1.5 text-sm text-gray-400 border border-gray-200 rounded-lg">
                                ‹ Prev
                            </span>
                        ...
                        @else
                            ...
                            <a
                                href="{{ $riwayat->previousPageUrl() }}"
                                class="px-3 py-1.5 text-sm text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition"
                            >
                                ‹ Prev
                            </a>
                        ...
                        @foreach($riwayat->getUrlRange(1, $riwayat->lastPage()) as $page => $url)
                            ...
                            <a
                                href="{{ $url }}"
                                class="px-3 py-1.5 text-sm rounded-lg border transition {{ $riwayat->currentPage() == $page ? 'bg-indigo-600 text-white border-indigo-600' : 'text-gray-700 border-gray-300 hover:bg-gray-50' }}"
                            >
                                {{ $page }}
                            </a>
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm sticky top-6">
                ...
                <div class="px-6 py-4 text-sm text-gray-500">
                    ...
                    Semua perubahan status laporan akan tercatat otomatis di halaman ini.
