...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm">
            Perbarui informasi pertanyaan atau jawaban untuk pelapor.
        </p>
    ...
    <script>
        ...
        function confirmUpdateFaq(event, formEl)
        {
            ...
            const pertanyaan = formEl
                .querySelector('input[name="pertanyaan"]')
                .value
                .trim();

            const jawaban = formEl
                .querySelector('textarea[name="jawaban"]')
                .value
                .trim();
            ...
            if (!pertanyaan || !jawaban)
            {
                Swal.fire({
                    ...
                    customClass: {
                        ...
                        confirmButton:
                            'swal2-confirm-custom swal2-confirm-error'
            ...
            Swal.fire({
                ...
                customClass: {
                    ...
                    confirmButton:
                        'swal2-confirm-custom swal2-confirm-success',
        ...
        <div class="p-6">
            ...
            >
                ...
                <div class="mb-4">
                    ...
                    @error('pertanyaan')
                        <p class="text-red-600 text-[11px] mt-1">
                            {{ $message }}
                        </p>
                    @enderror
