...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        {{-- DITERIMA --}}
        <a
            href="{{ route('admin.laporan.index', ['status' => 'diterima']) }}"
            class="bg-white rounded-2xl border border-gray-100 p-8 shadow-lg hover:shadow-2xl hover:border-[#2657c1] transition-all duration-300 group"
        >
        ...
        {{-- DIPROSES --}}
        <a
            href="{{ route('admin.laporan.index', ['status' => 'diproses']) }}"
            class="bg-white rounded-2xl border border-gray-100 p-8 shadow-lg hover:shadow-2xl hover:border-[#2657c1] transition-all duration-300 group"
        >
        ...
        {{-- SELESAI --}}
        <a
            href="{{ route('admin.laporan.index', ['status' => 'selesai']) }}"
            class="bg-white rounded-2xl border border-gray-100 p-8 shadow-lg hover:shadow-2xl hover:border-[#2657c1] transition-all duration-300 group"
        >
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <a
            href="{{ route('admin.admin-accounts.index') }}"
            class="bg-white rounded-2xl border border-gray-100 p-8 shadow-lg hover:shadow-2xl hover:border-[#2657c1] transition-all duration-300 group"
        >
