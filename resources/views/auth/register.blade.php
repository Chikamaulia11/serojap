<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            />
            <p id="password-error" class="text-red-500 text-sm mt-1" style="display: none;">Password minimal 8 karakter</p>
        ...
        <div class="mt-4">
            ...
            <x-text-input 
                ...
                autocomplete="new-password" 
            />
            <p id="confirm-error" class="text-red-500 text-sm mt-1" style="display: none;">Password minimal 8 karakter</p>
...
>>>>>>> b793b33 (backup sebelum merge)
    ...
    <script>
        ...
        // --- VALIDASI EMAIL: MERAH SELAGI BELUM ADA @GMAIL.COM ---
        emailInput.addEventListener('input', function() {
            const value = this.value;
            
            // Cek APAKAH BELUM diakhiri dengan @gmail.com
            if (!value.endsWith('@gmail.com')) {
                // SELAGI BELUM BENAR -> MERAH + TULISAN MUNCUL
                this.classList.add('border-error');
                this.classList.remove('border-normal');
                emailError.style.display = 'block';
            } else {
                // KALAU SUDAH BENAR -> BALIK BIRU
        ...
        // Biar pas pindah kolom (blur) tetep merah kalau salah
        ...
        passInput.addEventListener('input', () => validatePass(passInput, passError));
        confirmInput.addEventListener('input', () => validatePass(confirmInput, confirmError));
    </script>
</x-guest-layout>